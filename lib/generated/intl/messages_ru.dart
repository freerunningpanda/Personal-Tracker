...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m0(category) => "Лимит превышен для категории: \'${category}\'";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "cannotBeNegative":
            MessageLookupByLibrary.simpleMessage("Не может быть отрицательным"),
        ...
        "pleaseAddSomeTransactions": MessageLookupByLibrary.simpleMessage(
            "Пожалуйста, добавьте транзакции"),
        ...
        "travelling": MessageLookupByLibrary.simpleMessage("Путешествия"),
        "type": MessageLookupByLibrary.simpleMessage("Тип:"),
        "update": MessageLookupByLibrary.simpleMessage("Обновить"),
        "updateATransaction":
            MessageLookupByLibrary.simpleMessage("Обновить транзакцию"),
